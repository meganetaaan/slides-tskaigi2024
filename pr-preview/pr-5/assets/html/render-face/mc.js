...
["_fxMainIdle","_fxMainLaunch","_fxMainQuit","_fxMainTouch","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var ASM_CONSTS = {
  211184: () => { gxView.onBufferChanged(); },  
 211214: ($0, $1, $2, $3) => { gxView.onFormatChanged($0, $1, $2, $3); },  
 211258: ($0) => { gxView.onStart($0); },  
 211282: () => { gxView.onStop(); }
};
